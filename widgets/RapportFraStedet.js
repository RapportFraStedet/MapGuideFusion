...
Fusion.Widget.RapportFraStedet = OpenLayers.Class(Fusion.Widget, {
		...
		pan : function (data) {
			...
			if (this.zoom) {
				var o = this.zoom / 2;
				map.zoomToExtent([lonlat.lon - o, lonlat.lat - o, lonlat.lon + o, lonlat.lat + o]);
			} else
				map.panTo(lonlat);
		...
		createGeometry : function () {
			...
			if (geometry != "") {
				...
				if(oltGeometry.CLASS_NAME == 'OpenLayers.Geometry.Point' && this.zoom){
					var o = this.zoom / 2;
					map.zoomToExtent([oltGeometry.x - o, oltGeometry.y - o, oltGeometry.x + o, oltGeometry.y + o]);
				}
				else
				{
